<?php $pageTitle = 'Database Design Project'; require_once __DIR__ . '/../includes/functions.php'; $num = 10; $sectionDir = 'dbms-lessons'; $prevNext = getPrevNextLesson($num, $sectionDir); require_once __DIR__ . '/../includes/header.php'; ?>
